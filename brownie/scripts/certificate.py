...
def register_certificate (
   certificate_data:dict = {"name" : "Dennjiross","vaccine_type":"Sinovac","date":"22-02-2022"},
   holder_id_example:str = "612312312312313123",
   ipfs_address = "0xabfb3b9720db61e98f482c272d29c35ca26ce19cbae73fc81eb51fda31d21121"
   ) -> bool : 
   account = get_account_issuer()
   print(f"ACCOUNT NONCE ISSUER {account.nonce}")
